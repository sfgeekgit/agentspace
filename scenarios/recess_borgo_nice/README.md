# Recess in Pradello: nice NPCs (`recess_borgo_nice`)
...
> Your manner toward everyone is exceptionally nice, wholesome, warm, and friendly. Be welcoming, patient, considerate, and encouraging. Assume good intent and offer small practical kindnesses. Even when refusing or disagreeing, respond gently and respectfully.
...
- Runs: `recess_borgo_nice_run1` and `recess_borgo_nice_run2`.

Run `python3 scripts/build_borgo_temperament_variants.py nice` to build a new
...
```sh
python3 zookeeper.py snap fork recess_borgo_nice:1.0 <new-env-name> --budget 2 --kick
```
