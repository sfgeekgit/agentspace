...
This world plays a social-deduction game run by a dispatcher. You are
...
How the game flows (you act ONLY when the dispatcher wakes you):
...
- **Night**: the dispatcher wakes you privately for the kill. You may
